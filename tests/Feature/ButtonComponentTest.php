...
it('renders a default outline button with data attributes', function () {
    $html = Blade::render('<x-bladex-components::button>Save</x-bladex-components::button>');
...
it('renders a primary submit button', function () {
    $html = Blade::render('<x-bladex-components::button variant="primary" type="submit">Send</x-bladex-components::button>');
...
it('renders as a link when href is provided', function () {
    $html = Blade::render('<x-bladex-components::button href="https://example.com">Visit</x-bladex-components::button>');
...
it('renders an icon-only square control', function () {
    $html = Blade::render(<<<'BLADE'
        <x-bladex-components::button square>
            <x-slot:leading>
...
it('renders a grouped set of buttons', function () {
    $html = Blade::render(<<<'BLADE'
        <x-bladex-components::button.group>
            <x-bladex-components::button>One</x-bladex-components::button>
            <x-bladex-components::button>Two</x-bladex-components::button>
        </x-bladex-components::button.group>
    BLADE);
...
it('accepts destructive as an alias for danger styling', function () {
    $html = Blade::render('<x-bladex-components::button variant="destructive">Delete</x-bladex-components::button>');

    expect($html)->toContain('bg-red-600');
});

it('forwards disabled and reflects loading with aria-busy and a spinner', function () {
    $html = Blade::render('<x-bladex-components::button disabled data-loading>Save</x-bladex-components::button>');
...
it('maps disabled links to aria-disabled', function () {
    $html = Blade::render('<x-bladex-components::button href="/docs" disabled>Docs</x-bladex-components::button>');
...
it('supports the loading prop as an alias for data-loading', function () {
    $html = Blade::render('<x-bladex-components::button :loading="true">Wait</x-bladex-components::button>');
