...
it('renders a brand with name and logo url', function () {
    $html = Blade::render('<x-ui::brand href="/" name="Acme Inc." logo="/logo.svg" alt="Acme" />');
...
it('renders a logo-only brand', function () {
    $html = Blade::render('<x-ui::brand href="/home" logo="/logo.svg" />');
...
it('renders light and dark logo images', function () {
    $html = Blade::render('<x-ui::brand logo="/logo-light.svg" logo-dark="/logo-dark.svg" alt="Brand" />');
...
it('accepts logoDark as a constructor prop', function () {
    $html = Blade::render('<x-ui::brand :logo-dark="\'/logo-dark.svg\'" logo="/logo-light.svg" />');
