...
@section('content')
    <div class="space-y-10">
        <div class="space-y-1">
            ...
            <x-stencil::text size="sm" variant="subtle">Content container with header, body, and footer.</x-stencil::text>
        </div>
            ...
            <x-stencil::card>
                ...
                <x-stencil::card.content>
                    <x-stencil::text size="sm">
                        Update your display name, email, and notification settings. Changes apply across all
                        workspaces.
                    </x-stencil::text>
                </x-stencil::card.content>
