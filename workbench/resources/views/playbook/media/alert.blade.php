...
@section('content')
    <div class="space-y-10">
        <div class="space-y-1">
            ...
            <x-stencil::text size="sm" variant="subtle">Inline callouts for info, success, warning, and danger.</x-stencil::text>
        </div>
        ...
        <div class="mx-auto flex w-full max-w-xl flex-col gap-3">
            ...
            <x-stencil::alert variant="danger" title="Action required">
                <x-stencil::alert.description>Your API key was revoked. Generate a new one.</x-stencil::alert.description>
            </x-stencil::alert>
        </div>
    </div>
@endsection
