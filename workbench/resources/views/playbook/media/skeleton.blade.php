...
@section('content')
    <div class="space-y-10">
        <div class="space-y-1">
            ...
            <x-ui::heading :level="2">Skeleton</x-ui::heading>
            <x-ui::text size="sm" variant="subtle">Loading placeholders for content that is still arriving.</x-ui::text>
        </div>

        <div class="max-w-md space-y-6">
            <div class="flex items-center gap-4">
                <x-ui::skeleton rounded="full" class="size-12" />
            ...
            <x-ui::skeleton class="h-28 w-full rounded-xl" />
        </div>
    </div>
@endsection
