...
dark:group-data-[collapsible=icon]:group-has-data-[active=true]/menu-button:bg-zinc-900
dark:group-data-[collapsible=icon]:group-has-data-[active=true]/menu-item:bg-zinc-900
dark:group-data-[collapsible=icon]:peer-data-[active=true]/menu-button:bg-zinc-900
dark:peer-data-[active=true]/menu-button:text-zinc-900
dark:ring-zinc-300/20 dark:active:bg-zinc-800 dark:active:text-zinc-50
dark:text-zinc-200 dark:group-hover/menu-item:text-zinc-50 dark:group-has-data-[active=true]/menu-button:text-zinc-900
dark:text-zinc-200 dark:group-hover/menu-item:text-zinc-50 dark:group-has-data-[active=true]/menu-item:text-zinc-900
dark:text-zinc-200 dark:peer-hover/menu-button:text-zinc-50 dark:peer-data-[active=true]/menu-button:text-zinc-900
...
dark:text-zinc-400 dark:ring-zinc-300/20 dark:group-hover/menu-item:text-zinc-50 dark:hover:bg-zinc-800 dark:hover:text-zinc-50
...
data-[active=true]:bg-zinc-900 data-[active=true]:font-medium data-[active=true]:text-zinc-50 data-[active=true]:hover:bg-zinc-800 data-[active=true]:hover:text-zinc-50
...
group-data-[collapsible=icon]:group-has-data-[active=true]/menu-button:bg-zinc-50
...
group-data-[collapsible=icon]:peer-data-[active=true]/menu-button:bg-zinc-50
...
group-data-[collapsible=icon]:top-1.5! group-data-[collapsible=icon]:right-1.5! group-data-[collapsible=icon]:h-2 group-data-[collapsible=icon]:min-w-2 group-data-[collapsible=icon]:w-2 group-data-[collapsible=icon]:rounded-full group-data-[collapsible=icon]:p-0 group-data-[collapsible=icon]:text-[0px] group-data-[collapsible=icon]:leading-none group-data-[collapsible=icon]:bg-zinc-900
group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 group-has-data-[active=true]/menu-button:text-zinc-50 md:opacity-0 dark:group-has-data-[active=true]/menu-button:text-zinc-900
group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 group-has-data-[active=true]/menu-item:text-zinc-50 md:opacity-0 dark:group-has-data-[active=true]/menu-item:text-zinc-900
group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 peer-data-[active=true]/menu-button:text-zinc-50 md:opacity-0 dark:peer-data-[active=true]/menu-button:text-zinc-900
group-has-data-[collapsible=icon]/sidebar-wrapper:h-12
group-has-data-[sidebar=menu-action]/menu-item:pe-8
group-has-data-[size=default]/menu-button:top-1.5
group-has-data-[size=lg]/menu-button:top-2.5
group-has-data-[size=lg]/menu-item:top-2.5
group-has-data-[size=sm]/menu-button:top-1
group-has-data-[size=sm]/menu-item:top-1
group-hover/menu-item:text-zinc-950 group-has-data-[active=true]/menu-button:text-zinc-50
...
peer-hover/menu-button:text-zinc-950 peer-data-[active=true]/menu-button:text-zinc-50
...
ring-zinc-950/10 transition-transform group-hover/menu-item:text-zinc-950 hover:bg-zinc-100 hover:text-zinc-950 focus-visible:ring-2
...
sidebar__spacer min-h-0 shrink-0 grow-0
size-10 text-sm
size-11 text-sm
...
truncate text-sm font-semibold tracking-tight text-zinc-950 group-data-[collapsible=icon]:hidden dark:text-zinc-50
w-10
w-14
w-8
