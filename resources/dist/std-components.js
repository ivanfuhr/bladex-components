(() => {
  ...
  function lockScrollContainer(container) {
    ...
    container.dataset.stdScrollLocked = "true";
    ...
    if (scrollArea instanceof HTMLElement && !lockedScrollAreaRoots.has(scrollArea)) {
      lockedScrollAreaRoots.set(scrollArea, (_a5 = scrollArea.dataset.stdScrollLocked) != null ? _a5 : "");
      scrollArea.dataset.stdScrollLocked = "true";
    }
  ...
  function unlockScrollContainer(container) {
    ...
    container.scrollTop = saved.scrollTop;
    container.scrollLeft = saved.scrollLeft;
    delete container.dataset.stdScrollLocked;
    lockedScrollContainers.delete(container);
    const scrollArea = container.closest("[data-scroll-area]");
    if (scrollArea instanceof HTMLElement && lockedScrollAreaRoots.has(scrollArea)) {
      const previous = (_a5 = lockedScrollAreaRoots.get(scrollArea)) != null ? _a5 : "";
      if (previous) {
        scrollArea.dataset.stdScrollLocked = previous;
      } else {
        delete scrollArea.dataset.stdScrollLocked;
      }
  ...
  function openCommandDialog(dialog) {
    var _a5;
    if (typeof window !== "undefined" && ((_a5 = window.StdComponents) == null ? void 0 : _a5.dialog) && dialog.dataset.dialogName) {
  ...
  if (typeof window !== "undefined") {
    window.StdComponents = (_a = window.StdComponents) != null ? _a : {};
  ...
  function initDatetimePickers(root = document) {
    document.querySelectorAll("[data-datetime-picker-panel][data-std-portaled]").forEach((panel) => {
  ...
  function openDialog(dialog) {
    ...
    if (previouslyFocused) {
      dialog._stdPreviousFocus = previouslyFocused;
    }
    if (typeof dialog.showModal === "function") {
      dialog.showModal();
    } else {
    ...
    dialog.dispatchEvent(
      new CustomEvent("std:dialog:open", {
        bubbles: true,
  ...
  function bindDialog(dialog) {
    ...
    dialog.addEventListener("cancel", (event) => {
      ...
      dialog.dispatchEvent(
        new CustomEvent("std:dialog:cancel", {
          bubbles: true,
    ...
    dialog.addEventListener("close", () => {
      ...
      restoreFocus(dialog);
      dialog.dispatchEvent(
        new CustomEvent("std:dialog:close", {
          bubbles: true,
          detail: { name: name != null ? name : null }
        })
      );
  ...
  function restoreFocus(dialog) {
    const previous = dialog._stdPreviousFocus;
    if (previous instanceof HTMLElement && document.contains(previous)) {
      previous.focus();
    }
    delete dialog._stdPreviousFocus;
  }
  ...
  var _a2;
  if (typeof window !== "undefined") {
    window.StdComponents = (_a2 = window.StdComponents) != null ? _a2 : {};
    window.StdComponents.dialog = (name) => ({
      show: () => showDialog(name),
      close: () => closeDialog(name)
    });
    window.StdComponents.dialogs = {
  ...
  var _a3;
  if (typeof window !== "undefined") {
    window.StdComponents = (_a3 = window.StdComponents) != null ? _a3 : {};
  ...
  var _a4;
  if (typeof window !== "undefined") {
    window.StdComponents = (_a4 = window.StdComponents) != null ? _a4 : {};
  }
})();
