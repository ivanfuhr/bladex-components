...
>
    <div class="dialog__panel relative flex max-h-[min(76vh,calc(100dvh-4rem))] flex-col overflow-hidden p-0" data-dialog-panel>
        <h2 id="{{ $titleId }}" class="sr-only" data-dialog-title="{{ $titleId }}">{{ $resolvedTitle }}</h2>
        <p id="{{ $descriptionId }}" class="sr-only" data-dialog-description="{{ $descriptionId }}">{{ $resolvedDescription }}</p>
